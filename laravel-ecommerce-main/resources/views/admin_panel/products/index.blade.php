...
<div class="content-wrapper">
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Daftar Produk <a class="btn btn-lg btn-success" style="float:right;color:white" href="{{route('admin.products.create')}}">+ Tambah Produk</a></h4>
                    <br><br>
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($prdlist as $prd)
                                <tr>
                                    ...
                                    <td><a href="{{route('admin.products.delete', ['id' => $prd->id])}}"class="btn btn-danger">Hapus</a></td>
                                    <td>
                                        {{$prd->price}}
                                    </td>
                                    <td>
