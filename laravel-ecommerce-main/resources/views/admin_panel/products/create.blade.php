                        ...
                        <div class="card-body">
                            <a style="color:green;" href="{{route('admin.products')}}">
                                < Kembali ke Daftar Produk</a>
                                    ...
                                    <br>
                                    <img  id="imageHolder" src="" alt="tambahkan gambar" height="300" width="300"/>
                                    <br>
                                    ...
                                    <form class="forms-sample" method="post"  id="product_form">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <br>
                                            <a onclick="addColor()" class="btn btn-sm btn-primary" >masukkan warna</a>
                                            <br>
                                            <br>
                                        ...
                                        <input type="submit" name="saveButton" class="btn btn-success mr-2" id="saveButton" value="Tambahkan Produk"  />
                                    </form>
                                    @if($errors->any())
